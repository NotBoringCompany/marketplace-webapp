...
const Index = () => {
	...
	const listingHash = useWeb3Contract({
		...
		params: {
			...
			_endingPrice: 0,
			_minimumReserveBid: Web3.utils.toWei("1", "ether"),
			//Duration in seconds
			_duration: 10000,
			_txSalt: SALT,
		},
	...
	const atomicMatch = useWeb3Contract({
		...
		params: {
			...
			_txSalt: SALT,
			_signature:
				"0x43fc5c011db6cd1e72640ebd14365b3e3a7a74575d5ab8bd520ef7234b44c3f672b8868b1c910a6c4d373608a9905e9410290bae91960391b5991b4f31924c941b",
		},
	});
	...
	return (
		<div className="text-white">
			TESTING FOR BIDDINGS (MARKETPLACE).
			<br />
			<br />
